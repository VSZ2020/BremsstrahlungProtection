...
{
    public class SourceTabVM : BaseViewModel
    {
        #region Constructor
        ...
        public MaterialDto SelectedSourceMaterial { get => _selectedSourceMaterial; set { _selectedSourceMaterial = value; OnChanged(); SourceZ = _selectedSourceMaterial?.Z ?? 1; SourceDensity = _selectedSourceMaterial?.Density ?? 1; } }
